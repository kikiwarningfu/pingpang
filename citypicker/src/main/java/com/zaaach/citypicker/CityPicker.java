...
public class CityPicker {
    ...
    public static CityPicker from1(FragmentActivity activity) {
        return new CityPicker(activity);
    }
...
//        Fragment fragmentByTag = mFragmentManager.get().findFragmentByTag(TAG);
//        if (fragmentByTag != null){
//            fragmentByTag.locationChanged(location, state);
//        }
    }
}
