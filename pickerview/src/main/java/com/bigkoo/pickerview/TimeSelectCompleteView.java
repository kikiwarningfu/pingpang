 ...
 */
public class TimeSelectCompleteView extends BasePickerView implements View.OnClickListener {
    ...
    //构造方法
    public TimeSelectCompleteView(Builder builder) {
    ...
    public static class Builder {
        private int layoutRes = R.layout.pickerview_select_year_time;
        private CustomListener customListener;
        ...
        public TimeSelectCompleteView build() {
            return new TimeSelectCompleteView(this);
        }
    }
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.pickerview_select_year_time, contentContainer);
...
//            rv_top_bar.setBackgroundColor(Color_Background_Title == 0 ? pickerview_bg_topbar : Color_Background_Title);
        ...
        // 时间转轮 自定义控件
        LinearLayout timePickerView = (LinearLayout) findViewById(R.id.timepicker_min);
        LinearLayout timerPickerView2 = (LinearLayout) findViewById(R.id.timepicker_max);
//        timePickerView.setBackgroundColor(Color_Background_Wheel == 0 ? bgColor_default : Color_Background_Wheel);

        wheelTime = new MyWheelTime(timePickerView, timerPickerView2, type, gravity, Size_Content);
        ...
        setTime();
        wheelTime.setViewMinLabels(label_year, label_month, label_day, label_hours, label_mins, label_seconds);
    ...
    public void returnData() {
        if (timeSelectListener != null) {
            try {
                Date dateMax = WheelTime.dateFormat.parse(wheelTime.getTime());
                Date dateMin = WheelTime.dateFormat.parse(wheelTime.getTimeMin());
                timeSelectListener.onTimeSelect(dateMax, dateMin, clickView);
    ...
    public interface OnTimeSelectListener {
        void onTimeSelect(Date dateMax, Date dateMin, View v);
    }
