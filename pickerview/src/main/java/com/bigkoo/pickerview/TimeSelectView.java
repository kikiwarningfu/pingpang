 ...
 */
public class TimeSelectView extends BasePickerView implements View.OnClickListener {
    ...
    public static class Builder {
        private int layoutRes = R.layout.pickerview_select_year;
        private CustomListener customListener;
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.pickerview_select_year, contentContainer);
