 ...
 */
public class TimeGameSelectView extends BasePickerView implements View.OnClickListener {
    ...
    //构造方法
    public TimeGameSelectView(Builder builder) {
    ...
    public static class Builder {
        private int layoutRes = R.layout.pickerview_select_game;
        private CustomListener customListener;
        ...
        public TimeGameSelectView build() {
            return new TimeGameSelectView(this);
        }
    }
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            LayoutInflater.from(context).inflate(R.layout.pickerview_select_game, contentContainer);
