...
public abstract class BaseFormAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    // 数据源
    public List<T> mList;
    public static final String TAG=BaseFormAdapter.class.getSimpleName();
     ...
     */
    protected void setData(RecyclerView.ViewHolder viewHolder, int rowIndex, int columnIndex, T content) {

    }
    protected void setData(RecyclerView.ViewHolder viewHolder, int rowIndex, int columnIndex, T content,int position) {
