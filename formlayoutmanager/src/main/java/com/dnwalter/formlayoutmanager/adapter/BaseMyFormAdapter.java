...
public abstract class BaseMyFormAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public final static int TYPE_DEFAULT = 0;
    public Context mContext;
    // 数据源
    public List<T> mList;
    public static final String TAG = BaseMyFormAdapter.class.getSimpleName();
    int position = 0;
    private int ownPosition = 0;

    public BaseMyFormAdapter(Context context) {
        this(context, new ArrayList<T>());
    }

    public BaseMyFormAdapter(Context context, List<T> list) {
        mContext = context;
        mList = list;
    }
...
//        Log.e(TAG, "getItemCount: getRowCount==="+getRowCount()+"getColumnCount==="+getColumnCount() +"totalCount==="+(getRowCount() * getColumnCount()));
...
//        Log.e(TAG, "getItemViewType: rowIndex==="+rowIndex+"columnIndex===="+ columnIndex);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        position++;
        Log.e("BaseMyFormAdapter", "onCreateViewHolder position===" + position);
