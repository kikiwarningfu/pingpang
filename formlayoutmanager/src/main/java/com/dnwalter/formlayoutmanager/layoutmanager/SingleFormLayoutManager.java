 ...
 * @date 2019/10/14
 */
public class SingleFormLayoutManager extends RecyclerView.LayoutManager {
    public static final String TAG = SingleFormLayoutManager.class.getSimpleName();
    // 首次初始化数据完成
     ...
     */
    public SingleFormLayoutManager(int columnCount, RecyclerView recyclerView) {
        this(true, columnCount, recyclerView);
    }

    public SingleFormLayoutManager(boolean isHorV, int count, RecyclerView recyclerView) {
        mIsHorV = isHorV;
        if (isHorV) {
            mColumnCount = count;
        } else {
