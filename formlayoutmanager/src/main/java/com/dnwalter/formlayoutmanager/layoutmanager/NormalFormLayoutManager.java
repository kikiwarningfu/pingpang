...
public class NormalFormLayoutManager extends RecyclerView.LayoutManager {
    ...
    public NormalFormLayoutManager() {

    }
    public NormalFormLayoutManager(int columnCount) {
    ...
    public NormalFormLayoutManager(boolean isHorV, int count) {
     ...
     */
    public NormalFormLayoutManager(int columnCount, RecyclerView recyclerView) {
        this(true, columnCount, recyclerView);
    }

    public NormalFormLayoutManager(boolean isHorV, int count, RecyclerView recyclerView) {
        mIsHorV = isHorV;
        if (isHorV) {
            mColumnCount = count;
        } else {
     ...
     * @param type
     */
    public void startShow(@FormLayoutManager.StartShowType int type) {
        mStartShowType = type;
    }
