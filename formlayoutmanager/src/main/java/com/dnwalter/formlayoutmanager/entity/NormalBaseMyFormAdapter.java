...
public abstract class NormalBaseMyFormAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    public final static int TYPE_DEFAULT = 0;
    public Context mContext;
    // 数据源
//    public List<T> mList;
    public static final String TAG = NormalBaseMyFormAdapter.class.getSimpleName();
    int position = 0;
    private int ownPosition = 0;

//    public NormalBaseMyFormAdapter(Context context) {
//        this(context);
//    }
