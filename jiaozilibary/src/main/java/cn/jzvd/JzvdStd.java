...
public class JzvdStd extends Jzvd {
    ...
    public LinearLayout batteryTimeLayout, llBuyPurchase;
    ...
    public boolean isShowTravicerView = false;
    ...
    public void init(Context context) {
        ...
        llBuyPurchase = findViewById(R.id.ll_buy_purchase);
...
//        }
    ...
    public void gotoFullscreen() {
        ...
        //进入全屏
        if (isShowTravicerView) {
            llBuyPurchase.setVisibility(VISIBLE);
        } else {
            llBuyPurchase.setVisibility(GONE);
        }
    }
    ...
    public void setShowTravierView(boolean isShow) {
        isShowTravicerView = isShow;
        if (isShow) {
            llBuyPurchase.setVisibility(VISIBLE);
        } else {
            llBuyPurchase.setVisibility(GONE);
...
//            clarityPopWindow.update(clarity, -offsetX, -offsetY, Math.round(layout.getMeasuredWidth() * 2), layout.getMeasuredHeight());
    ...
    public void setScreenNormal() {
        ...
        //正常布局下的UI显示
        fullscreenButton.setImageResource(R.drawable.img_bt_large_screen);
    ...
    public void updateStartImage() {
        if (state == STATE_PLAYING) {
            Log.e("msg", "STATE_PLAYING");
            startButton.setVisibility(VISIBLE);
            startButton.setImageResource(R.drawable.jz_click_pause_selector);
//            replayTextView.setVisibility(GONE);
        } else if (state == STATE_ERROR) {
            startButton.setVisibility(INVISIBLE);
            Log.e("msg", "STATE_ERROR");

//            replayTextView.setVisibility(GONE);
        } else if (state == STATE_AUTO_COMPLETE) {
            startButton.setVisibility(VISIBLE);
            startButton.setImageResource(R.drawable.jz_click_replay_selector);
            Log.e("msg", "STATE_AUTO_COMPLETE");

//            replayTextView.setVisibility(VISIBLE);
        } else {
            Log.e("msg", "播放中  缓存中 还是啥？");
            startButton.setVisibility(VISIBLE);
