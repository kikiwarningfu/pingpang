...
public abstract class Jzvd extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    public LinearLayout llBuyPurchase;
...
//    public void setShowCenterTravicerView(boolean isSee, int time) {
//        if (isSee) {
//            //可以看多少秒
//
//            //可以看
...
//                Log.v(TAG, "onProgressUpdate " + "[" + this.hashCode() + "] ");
    ...
    static OnJzvdListener listener;

    public void setJzVdListener(OnJzvdListener listener) {
