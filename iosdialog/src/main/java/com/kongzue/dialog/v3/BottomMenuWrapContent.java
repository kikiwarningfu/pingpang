 ...
 */
public class BottomMenuWrapContent extends BaseDialog {
    ...
    private BottomMenuWrapContent() {
    }

    public static BottomMenuWrapContent build(@NonNull AppCompatActivity context) {
        synchronized (BottomMenu.class) {
            BottomMenuWrapContent bottomMenu = new BottomMenuWrapContent();
            bottomMenu.log("装载底部菜单: " + bottomMenu.toString());
            bottomMenu.context = new WeakReference<>(context);
            bottomMenu.build(bottomMenu, R.layout.bottom_menu_ios_wrap);
            return bottomMenu;
        }
    }

    public static BottomMenuWrapContent show(@NonNull AppCompatActivity context, List<String> menuTextList, OnMenuItemClickListener onMenuItemClickListener) {
        BottomMenuWrapContent bottomMenu = build(context);
    ...
    public static BottomMenuWrapContent show(@NonNull AppCompatActivity context, BaseAdapter customAdapter, OnMenuItemClickListener onMenuItemClickListener) {
        BottomMenuWrapContent bottomMenu = build(context);
    ...
    public static BottomMenuWrapContent show(@NonNull AppCompatActivity context, String title, List<String> menuTextList, OnMenuItemClickListener onMenuItemClickListener) {
        BottomMenuWrapContent bottomMenu = build(context);
        bottomMenu.menuTextList = menuTextList;
    ...
    public static BottomMenuWrapContent show(@NonNull AppCompatActivity context, String title, BaseAdapter customAdapter, OnMenuItemClickListener onMenuItemClickListener) {
        BottomMenuWrapContent bottomMenu = build(context);
        bottomMenu.customAdapter = customAdapter;
        bottomMenu.title = title;
        bottomMenu.onMenuItemClickListener = onMenuItemClickListener;
    ...
    public static BottomMenuWrapContent show( int Dialogwidth,@NonNull AppCompatActivity context, String[] menuTexts, OnMenuItemClickListener onMenuItemClickListener) {
        BottomMenuWrapContent bottomMenu = build(context);
    ...
    public static BottomMenuWrapContent show(@NonNull AppCompatActivity context, String title, String[] menuTexts, OnMenuItemClickListener onMenuItemClickListener) {
        BottomMenuWrapContent bottomMenu = build(context);
        List<String> list = new ArrayList<>();
        for (String s : menuTexts) {
            list.add(s);
...
//        rlContent.setLayoutParams(layoutParams);
        ...
        listMenu = rootView.findViewById(R.id.list_wrap_menu);
...
//            }
    ...
    public class NormalMenuArrayAdapter extends ArrayAdapter {
        ...
        @Override
        public View getView(int position, View convertView, ViewGroup parent) {
            NormalMenuArrayAdapter.ViewHolder viewHolder = null;
            if (convertView == null) {
                ...
                viewHolder = (NormalMenuArrayAdapter.ViewHolder) convertView.getTag();
            }
            String text = objects.get(position);
            if (null != text) {
                viewHolder.textView.setText(text);
    ...
    public BottomMenuWrapContent setMenuTextList(List<String> menuTextList) {
        this.menuTextList = menuTextList;
        refreshView();
        return this;
    }

    public BottomMenuWrapContent setMenuTextList(String[] menuTexts) {
        List<String> list = new ArrayList<>();
        for (String s : menuTexts) {
            list.add(s);
        }
    ...
    public BottomMenuWrapContent setTitle(String title) {
        this.title = title;
        refreshView();
        return this;
    }

    public BottomMenuWrapContent setTitle(int titleResId) {
    ...
    public BottomMenuWrapContent setCancelButtonText(String cancelButtonText) {
        this.cancelButtonText = cancelButtonText;
        refreshView();
        return this;
    }

    public BottomMenuWrapContent setCancelButtonText(int cancelButtonTextResId) {
    ...
    public BottomMenuWrapContent setShowCancelButton(boolean showCancelButton) {
    ...
    public BottomMenuWrapContent setOnMenuItemClickListener(OnMenuItemClickListener onMenuItemClickListener) {
    ...
    public BottomMenuWrapContent setMenuTitleTextInfo(TextInfo menuTitleTextInfo) {
    ...
    public BottomMenuWrapContent setMenuTextInfo(TextInfo menuTextInfo) {
    ...
    public BottomMenuWrapContent setCancelButtonTextInfo(TextInfo cancelButtonTextInfo) {
    ...
    public BottomMenuWrapContent setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    public BottomMenuWrapContent setOnShowListener(OnShowListener onShowListener) {
    ...
    public BottomMenuWrapContent setCustomView(View customView) {
    ...
    public BottomMenuWrapContent setCustomView(int customViewLayoutId, OnBindView onBindView) {
    ...
    public interface OnBindView {
        void onBind(BottomMenuWrapContent bottomMenu, View v);
    }
    ...
    public BottomMenuWrapContent setStyle(DialogSettings.STYLE style) {
        if (isAlreadyShown) {
        ...
        switch (this.style) {
            case STYLE_IOS:
                build(this, R.layout.bottom_menu_ios_wrap);
                break;
            case STYLE_KONGZUE:
                build(this, R.layout.bottom_menu_ios_wrap);
                break;
    ...
    public BottomMenuWrapContent setTheme(DialogSettings.THEME theme) {
    ...
    public BottomMenuWrapContent setCustomAdapter(BaseAdapter customAdapter) {
    ...
    public BottomMenuWrapContent setCustomDialogStyleId(int customDialogStyleId) {
        if (isAlreadyShown) {
            error("必须使用 build(...) 方法创建时，才可以使用 setTheme(...) 来修改对话框主题或风格。");
            return this;
        }
