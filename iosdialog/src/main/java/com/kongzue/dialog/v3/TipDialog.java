...
public class TipDialog extends BaseDialog {
    public static final String TAG = TipDialog.class.getSimpleName();
    ...
    public static TipDialog showWait(AppCompatActivity context, String message, boolean isCancelable) {
        //Log.e(TAG, "showWait: 111");
        synchronized (TipDialog.class) {
    ...
    public static TipDialog showWait(AppCompatActivity context, int messageResId, boolean isCancelable) {
        ...
        synchronized (TipDialog.class) {
            ...
            if (waitDialog == null) {
                ...
                //Log.e(TAG, "showWait: TipDialog  !null" );
