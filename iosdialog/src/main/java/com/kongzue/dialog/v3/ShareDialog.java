...
//    private ViewGroup boxItem;
    LinearLayout llPengyouquan,llWeixin,llQQ;
    ...
    public static ShareDialog show(@NonNull AppCompatActivity context, List<Item> itemList, ShareDialog.setOnItemClickListener onItemClickListener) {
        ShareDialog shareDialog = build(context);
        shareDialog.items = itemList;
        shareDialog.setOnItemClickListener = onItemClickListener;
        shareDialog.show();
        return shareDialog;
    }
...
//        boxItem = rootView.findViewById(R.id.box_item);
        ...
        llPengyouquan = rootView.findViewById(R.id.ll_pengyouquan);
        llWeixin = rootView.findViewById(R.id.ll_wx);
        llQQ = rootView.findViewById(R.id.ll_qq);
        llQQ.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(setOnItemClickListener!=null)
                {
                    setOnItemClickListener.onClick(2);
                    doDismiss();
                }
            }
        });
        llWeixin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(setOnItemClickListener!=null)
                {
                    setOnItemClickListener.onClick(0);
                    doDismiss();
                }
            }
        });
        llPengyouquan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(setOnItemClickListener!=null)
                {
                    setOnItemClickListener.onClick(1);
                    doDismiss();
                }
            }
        });
...
//                    isTouchDown = false;
    ...
    public void setSetOnItemClickListener(setOnItemClickListener listener) {
