 ...
 *
 */
public class MyTagRegisterDetailAdapter extends TagAdapter<RegistrationBean.LeaderBean> {
    private Context context;
    List<RegistrationBean.LeaderBean> datas = new ArrayList<>();

    public MyTagRegisterDetailAdapter(Context context, List<RegistrationBean.LeaderBean> datas) {
        super(datas);
        this.context = context;
        this.datas = datas;
    }

    public void notifyDatas(List<RegistrationBean.LeaderBean> datas) {
        this.datas = datas;
        notifyDataChanged();
    }

    @Override
    public View getView(FlowLayout parent, int position, RegistrationBean.LeaderBean tagBean) {
