...
public class BeginStartLiveActivity extends BaseActivity implements View.OnClickListener {
    private RtcEngine engine;
    private static final String TAG = BeginStartLiveActivity.class.getSimpleName();
    ...
    public void goActivity(Context context, String id) {
        Intent intent = new Intent(context, BeginStartLiveActivity.class);
    ...
    public int getLayoutRes() {
        return R.layout.activity_begin_start_live;
    }
    ...
    public void initView(@Nullable Bundle savedInstanceState) {
        ...
        latency = findViewById(R.id.btn_latency);
        ...
        findViewById(R.id.btn_latency).setOnClickListener(this);
        findViewById(R.id.foreground_video).setOnClickListener(this);
        foreGroundVideo = findViewById(R.id.background_video);
...
//        handler.post(RtcEngine::destroy);
    ...
    private void joinChannel(String channelId) {
        ...
        if (TextUtils.equals(accessToken, "") || TextUtils.equals(accessToken, "00631b6eef5fb5e41eea48544d9bc1d53a1IADyfEqc1I3Ok1T3FnE0mdkYwh9ESZHp9d3tqi549wp0xblwi4sAAAAAEAD+bihbWaNBYQEAAQBZo0Fh")) {
            accessToken = null;
        }
