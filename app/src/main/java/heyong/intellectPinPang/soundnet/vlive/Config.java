package heyong.intellectPinPang.soundnet.vlive;
...
import heyong.intellectPinPang.soundnet.vlive.protocol.model.model.AppVersionInfo;
import heyong.intellectPinPang.soundnet.vlive.protocol.model.model.GiftInfo;
import heyong.intellectPinPang.soundnet.vlive.protocol.model.model.MusicInfo;
...
public class Config {
    ...
    public Config(MyApp application) {
...
//                Log.e(TAG, "createVideoEncoderConfig: 1" );
...
//            case LIVE_TYPE_SINGLE_HOST:
                Log.e(TAG, "createVideoEncoderConfig:2" );
...
//                Log.e(TAG, "createVideoEncoderConfig:3" );
//
//                return new VideoEncoderConfiguration(
...
//                Log.e(TAG, "createVideoEncoderConfig:4" );
//
//                return new VideoEncoderConfiguration(
...
//                Log.e(TAG, "createVideoEncoderConfig:5" );
//
//                return new VideoEncoderConfiguration(
