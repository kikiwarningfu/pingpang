package heyong.intellectPinPang.soundnet.vlive.protocol.model.request;
...
public class Request {
    ...
    public static final int PRODUCT_BEGIN_LIVE = 25;//开始直播
    public static final int PRODUCT_SUSPPEND_LIVE = 26;//暂停直播
    public static final int PRODUCT_CONTINUE_LIVE = 27;//继续直播
    public static final int PRODUCT_END_LIVE = 28;//结束直播

    public static final int PRODUCT_OPEN_CLOUD_RECORD = 32;//开启云端录制
    public static final int PRODUCT_CLOSE_CLOUD_RECORD = 33;//关闭云端录制


    public static final int PRODUCT_INTO_LIVE = 29;//进入直播间
    public static final int PRODUCT_LEAVE_LIVE = 30;//离开直播间
    public static final int PRODUCT_BUY_VIDEO_LIVE = 31;//购买完整视频
