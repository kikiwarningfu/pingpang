 ...
 * 大分类的直播界面UI
 */
public class NewZhiboChildFragment extends BaseFragment<FragmentNewZhiboBinding, BaseViewModel>
    ...
    public static final String TAG = NewZhiboChildFragment.class.getSimpleName();
