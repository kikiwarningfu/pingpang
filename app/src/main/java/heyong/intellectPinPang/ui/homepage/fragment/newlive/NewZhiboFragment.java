...
import heyong.intellectPinPang.adapter.live.AllZhiBoAdapter;
import heyong.intellectPinPang.bean.live.LiveListBean;
import heyong.intellectPinPang.bus.RxBus;
import heyong.intellectPinPang.databinding.FragmentNewZhiboBinding;
 ...
 * 大分类的直播界面UI
 */
public class NewZhiboFragment extends BaseFragment<FragmentNewZhiboBinding, BaseViewModel>
        implements View.OnClickListener, BaseQuickAdapter.OnItemChildClickListener, OnRefreshListener {
    private AllZhiBoAdapter allZhiBoAdapter;
    List<LiveListBean.ListBean> list = new ArrayList<>();
    MyRefreshAnimHeader mRefreshAnimHeader;
    public static final String TAG = NewZhiboFragment.class.getSimpleName();
    ...
    public void initView(@Nullable Bundle savedInstanceState) {
        ...
        allZhiBoAdapter = new AllZhiBoAdapter();
        binding.setListener(this);
