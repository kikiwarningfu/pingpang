...
import heyong.intellectPinPang.utils.PDFUtil;
...
public class FileDisplayActivity extends Activity implements ReaderCallback,
    ...
    private String mtestFileUrl = "http://images.xlttsports.com/%E6%B5%8B%E8%AF%95PDF2.pdf", mFileName, fileName;//文件url 由文件url截取的文件名 上个页面传过来用于显示的文件名
    public static final String TAG = FileDisplayActivity.class.getSimpleName();
    private String totalUrl="http://images.xlttsports.com/%E6%B5%8B%E8%AF%95PDF2.pdf";
    Handler mainHandler;
    private String mFileUrl = "";
    private String mTotalUrl="";
    public static final String FILE_URL="file_url";
    public static final String TOTAL_URL="total_url";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.activity_pdf_preview);
        mtestFileUrl=getIntent().getStringExtra(FILE_URL);
        totalUrl=getIntent().getStringExtra(TOTAL_URL);
        findViewById();
        getFileUrlByIntent();
        ...
        rl_tbsView.addView(mTbsReaderView, new RelativeLayout.LayoutParams(
                ...
                ViewGroup.LayoutParams.MATCH_PARENT));
        try {
            mFileUrl= URLDecoder.decode(mtestFileUrl,"UTF-8");
            mTotalUrl= URLDecoder.decode(totalUrl,"UTF-8");
            Log.e(TAG, "onCreate: " + mFileUrl);
            Log.e(TAG, "onCreate: "+mTotalUrl.replace("http://images.xlttsports.com/","")
            .replace(".pdf",""));
            tv_title.setText(""+mTotalUrl.replace("http://images.xlttsports.com/","")
                    .replace(".pdf",""));
...
//        Log.e(TAG, "onCreate: ", );
        {
            ...
            if (isLocalExist() || mFileUrl.contains("storage")) {
                ...
                boolean localExist = isLocalExist();
                Log.e(TAG, "onCreate: 文件是否已存在 localExist=" + localExist);
                startDownload();
            }
        }
    }
    ...
    private void findViewById() {
        ...
        ImageView iv_back = findViewById(R.id.iv_finish);
        tv_title = findViewById(R.id.tv_center);
