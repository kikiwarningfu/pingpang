...
import heyong.intellectPinPang.databinding.FrgamentPlayBackBinding;
 ...
 * 回放的Fragment
 */
public class PlayBackFragment extends BaseFragment<FrgamentPlayBackBinding, LiveViewModel> implements
    ...
    public PlayBackFragment(String strMatchId) {
    ...
    public int getLayoutRes() {
        return R.layout.frgament_play_back;
    }
    ...
    public void initView(@Nullable Bundle savedInstanceState) {
        ...
        RxBus.getDefault().toObservable(PlayBackEvent.class).subscribe(tagEvents -> {
...
//        goActivity(AliPlayVideoActivity.class);
    ...
    private void getData() {
        viewModel.liveBroadcastMatchAgainstList("" + matchId, "", "" + pageNum, "" + pageSize, "" + searchWord, "1");
