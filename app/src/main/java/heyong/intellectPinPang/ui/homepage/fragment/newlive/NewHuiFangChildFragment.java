 ...
 * 新的回放界面
 */
public class NewHuiFangChildFragment extends BaseFragment<FragmentNewHuifangBinding, BaseViewModel>
    ...
    public static final String TAG = NewHuiFangChildFragment.class.getSimpleName();
