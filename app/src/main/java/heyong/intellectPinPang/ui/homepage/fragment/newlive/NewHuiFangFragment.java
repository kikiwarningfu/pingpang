...
import heyong.intellectPinPang.adapter.live.AllLuBoAdapter;
 ...
 * 新的回放界面
 */
public class NewHuiFangFragment extends BaseFragment<FragmentNewHuifangBinding, BaseViewModel>
        implements View.OnClickListener, BaseQuickAdapter.OnItemChildClickListener, OnRefreshListener {
    private AllLuBoAdapter allZhiBoAdapter;
    List<LiveListBean.ListBean> list = new ArrayList<>();
    MyRefreshAnimHeader mRefreshAnimHeader;
    public static final String TAG = NewHuiFangFragment.class.getSimpleName();
    ...
    public void initView(@Nullable Bundle savedInstanceState) {
        ...
        allZhiBoAdapter = new AllLuBoAdapter();
        binding.setListener(this);
