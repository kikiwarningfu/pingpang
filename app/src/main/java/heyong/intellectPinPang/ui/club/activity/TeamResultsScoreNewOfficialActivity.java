 ...
 * 团体比赛成绩   对内比赛
 */
public class TeamResultsScoreNewOfficialActivity extends BaseActivity<ActivityTeamResultsScoreBinding, HomePageViewModel> implements View.OnClickListener {
                            ...
                            if (chessBean != null) {
                                ...
                                if (TextUtils.isEmpty(status)||status.equals("0")) {
                                    ...
                                    if (i == 0) {
                                        ...
                                        mBinding.tvScoreOne.setEnabled(false);
                                        mBinding.tvScoreOne.setText("待赛");
                                        ...
                                        mBinding.tvScoreTwo.setEnabled(false);
                                        mBinding.tvScoreTwo.setText("待赛");
                                        ...
                                        mBinding.tvThreeScore.setEnabled(false);
                                        mBinding.tvThreeScore.setText("待赛");
                                        ...
                                        mBinding.tvFourScore.setEnabled(false);
                                        mBinding.tvFourScore.setText("待赛");
                                        ...
                                        mBinding.tvFifthScore.setEnabled(false);
                                        mBinding.tvFifthScore.setText("待赛");
...
//                        .show();
            ...
            case R.id.tv_right:
                if (AntiShakeUtils.isInvalidClick(v))
                    return;
                new MessageDialogBuilder(TeamResultsScoreNewOfficialActivity.this)
    ...
    private void goDoubleDetail(String ids, String status) {
        Intent intent = new Intent(TeamResultsScoreNewOfficialActivity.this, DoubleDetailScoreOfficialActivity.class);
...
//        }
    ...
    private void goSingleDetail(String ids, String status) {//SinglesDetailOfficialActivity
        Intent intent = new Intent(TeamResultsScoreNewOfficialActivity.this, SinglesDetailScoreOfficialActivity.class);
