 ...
 * 比赛调台
 */
public class MatchRadioView extends BasePickerView implements View.OnClickListener {
    ...
    //构造方法
    public MatchRadioView(Builder builder) {
    ...
    public static class Builder {
        private int layoutRes = R.layout.pop_radio_up;
        private CustomListener customListener;
        ...
        public MatchRadioView build() {
            return new MatchRadioView(this);
        }
    }
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            View view = LayoutInflater.from(context).inflate(R.layout.pop_radio_up, contentContainer);
