 ...
 * 比赛打法  M1男子团体-队伍2
 */
public class MatchPlayerAdapter extends BaseQuickAdapter<SelectPeopleProjectItemBean.Players, BaseViewHolder> {
    public MatchPlayerAdapter() {
    ...
    protected void convert(BaseViewHolder helper, SelectPeopleProjectItemBean.Players item) {
        ...
        if (TextUtils.isEmpty(leftOneName)) {
            ...
            binding.tvLeftGroupName.setText("" + item.getLeftOneName());
        }
