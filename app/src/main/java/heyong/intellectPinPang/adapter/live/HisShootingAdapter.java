 ...
 * 自己拍摄
 */
public class HisShootingAdapter extends BaseQuickAdapter<LiveUserOrderListBean.ListBean, BaseViewHolder> {
    /**
     * 1 全部
     * 待直播  开始直播  放弃悬赏
     * 已完成
...
//                Log.e(TAG, "getItemType: type==="+o.getType());
        ...
        multiTypeDelegate.registerItemType(0, R.layout.item_his_shooting_to_live);//待直播
        multiTypeDelegate.registerItemType(1, R.layout.item_his_shooting_to_completed);//待直播
