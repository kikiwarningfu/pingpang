 ...
 * 积分的左侧布局
 */
public class TitleIntergalLeftOfficialAdapter extends RecyclerView.Adapter<TitleIntergalLeftOfficialAdapter.ItemHolder> {
    ...
    @NonNull
    @Override
    public TitleIntergalLeftOfficialAdapter.ItemHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view;
//        if (i==0){
...
//        }
    ...
    @Override
    public void onBindViewHolder(@NonNull TitleIntergalLeftOfficialAdapter.ItemHolder viewHolder, int position) {
