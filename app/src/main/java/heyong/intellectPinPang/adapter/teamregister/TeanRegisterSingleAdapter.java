 ...
 * 俱乐部报名  ---单打人员
 */
public class TeanRegisterSingleAdapter extends BaseQuickAdapter<MatchOrderInfoBean.RefereeBean, BaseViewHolder> {
    private int width;
    private Context context;

    public TeanRegisterSingleAdapter(Context context, int width) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, MatchOrderInfoBean.RefereeBean item) {
        //设置图片圆角角度
