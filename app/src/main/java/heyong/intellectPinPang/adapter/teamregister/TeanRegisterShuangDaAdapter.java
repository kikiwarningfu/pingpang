 ...
 * 俱乐部报名团体人员
 */
public class TeanRegisterShuangDaAdapter extends BaseQuickAdapter<MatchOrderInfoBean.PlayersBean.TeamsBean, BaseViewHolder> {
    private int width;
    private Context context;
    MyDividerItemDecoration mSixDiD;
    private String teamTitle;

    public TeanRegisterShuangDaAdapter(Context context, int width, MyDividerItemDecoration mSixDiD, String teamTitle) {
