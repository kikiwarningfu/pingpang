 ...
 * 单打比赛成绩
 */
public class DisplaySinglesDetailOfficialAdapter extends BaseQuickAdapter<DisplayBeginArrangeBean.ChessBean, BaseViewHolder> {
    ...
    public DisplaySinglesDetailOfficialAdapter(boolean isFirst) {
        super(R.layout.item_single_detail);
        this.isFirst = isFirst;
    }

    @Override
    protected void convert(BaseViewHolder helper, DisplayBeginArrangeBean.ChessBean item) {
...
//                }
    ...
    public interface onMyListener {
        void OnMyListener(int scoreOne, int scoreTwo, DisplayBeginArrangeBean.ChessBean item, int position
