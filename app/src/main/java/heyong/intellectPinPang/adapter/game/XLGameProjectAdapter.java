 ...
 * 比赛性别的适配器
 */
public class XLGameProjectAdapter extends BaseQuickAdapter<XlZhiboGetMatchScreenDataBean.ProjectBean.SexBean.ItemBean, BaseViewHolder> {

    public XLGameProjectAdapter() {
        super(R.layout.item_group_select_xl);
    }

    @Override
    protected void convert(BaseViewHolder helper, XlZhiboGetMatchScreenDataBean.ProjectBean.SexBean.ItemBean item) {
