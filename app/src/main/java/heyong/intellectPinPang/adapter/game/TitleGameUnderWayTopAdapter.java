 ...
 * @date 2019/12/2
 */
public class TitleGameUnderWayTopAdapter extends RecyclerView.Adapter<TitleGameUnderWayTopAdapter.ItemHolder> {
    private List<TitleBean> mList;
    public static final String TAG= TitleGameUnderWayTopAdapter.class.getSimpleName();
    public TitleGameUnderWayTopAdapter(List<TitleBean> list) {
        mList = list;
    }
    private int types = 1;
    @NonNull
    @Override
    public TitleGameUnderWayTopAdapter.ItemHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view;
...
//        }
    ...
    @Override
    public void onBindViewHolder(@NonNull TitleGameUnderWayTopAdapter.ItemHolder viewHolder, int position) {
