 ...
 * 单打比赛成绩
 */
public class SinglesDetailAdapter extends BaseQuickAdapter<QueryChessInfoBean.XlClubContestArrangeChessesBean, BaseViewHolder> {
    ...
    public SinglesDetailAdapter(boolean isFirst) {
...
//        helper.addOnClickListener(R.id.et_two_score);
        ...
        Log.e(TAG, "convert: "+item.getStatus() );
        if (status == 3) {
            ...
            Log.e(TAG, "convert: isTextSubmit==="+item.isTextSubmit() +"convert: isFirst==="+item.isFirst());
...
//                        binding.etOneScore.setEnabled(false);
//                        binding.etTwoScore.setEnabled(false);
//                        Log.e(TAG, "onClick: 2222222222222222222222222222" );
//
//                    } else {
//                        item.setCanChange(true);
//                        Log.e(TAG, "onClick: 33333333333333333333333333333333" );
//                        binding.etOneScore.setEnabled(true);
//                        binding.etTwoScore.setEnabled(true);
