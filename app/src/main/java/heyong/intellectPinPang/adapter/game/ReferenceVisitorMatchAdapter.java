...
//游客
public class ReferenceVisitorMatchAdapter extends BaseQuickAdapter<TableNumArrangeBean.ArrangesBean, BaseViewHolder> {

    public ReferenceVisitorMatchAdapter() {
        super(0);
...
//                    binding.llCanLive.setVisibility(View.VISIBLE);
                ...
                } else if (status == 1 || status == 3 || status == 4 || status == 6||status==2) {
