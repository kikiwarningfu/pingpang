 ...
 * 选择教练员的适配器
 */
public class SelectAthletesAndCoachesAdapter extends BaseQuickAdapter<ChooseJoinMatchUserBean.PlayersBean, BaseViewHolder> {
    private Context context;
    private int width;

    public SelectAthletesAndCoachesAdapter(Context context, int width) {
