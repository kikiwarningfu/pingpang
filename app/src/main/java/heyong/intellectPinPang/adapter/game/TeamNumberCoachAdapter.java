...
public class TeamNumberCoachAdapter extends BaseQuickAdapter<TeamMemberByMatchBean.CoachesBean, BaseViewHolder> {
    private Context context;
    private int width;

    public TeamNumberCoachAdapter(Context context, int width) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, TeamMemberByMatchBean.CoachesBean item) {
