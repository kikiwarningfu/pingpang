...
public class UpdatexlClubContestArrangeBean {
    public UpdatexlClubContestArrangeBean() {
    }

    private List<XlClubContestArrangeVOListBean> xlClubContestArrangeVOList;

    public List<XlClubContestArrangeVOListBean> getXlClubContestArrangeVOList() {
        return xlClubContestArrangeVOList;
    }

    public void setXlClubContestArrangeVOList(List<XlClubContestArrangeVOListBean> xlClubContestArrangeVOList) {
        this.xlClubContestArrangeVOList = xlClubContestArrangeVOList;
    }

    public static class XlClubContestArrangeVOListBean {
        /**
